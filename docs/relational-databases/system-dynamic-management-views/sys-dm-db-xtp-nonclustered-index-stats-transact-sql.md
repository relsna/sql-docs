...
[!INCLUDE[sql-asdb-asdbmi](../../includes/applies-to-version/sql-asdb-asdbmi.md)]
 ...
 For more information about memory-optimized, nonclustered indexes, see [SQL Server In-Memory OLTP Internals for SQL Server 2016](https://docs.microsoft.com/en-us/sql/relational-databases/in-memory-oltp/sql-server-in-memory-oltp-internals-for-sql-server-2016), page 20.  
